...
if __name__ == "__main__":
    ...
    env_kwargs = dict(max_cycles=900, max_zombies=10, vector_state=True, killable_knights=False, killable_archers=False)

    # Train a model (takes ~5 minutes on a laptop CPU)
    train(env_fn, steps=102_400, seed=0, **env_kwargs)
